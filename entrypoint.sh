...
# Start gameserver
${CS2_DIR}/game/cs2.sh +ip ${IP} -port ${PORT} -dedicated -game csgo -console -usercon +map ${MAP} +game_type ${GAME_TYPE} +game_mode ${GAME_MODE} +exec autoexec.cfg ${EXTRAARG} +mapgroup ${MAPGROUP} -maxplayers "${MAXPLAYERS}"
